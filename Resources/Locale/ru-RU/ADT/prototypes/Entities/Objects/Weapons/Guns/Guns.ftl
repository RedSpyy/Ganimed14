ent-ADTWeaponSaberRevBlueshield = энергетический револьвер офицера синего щита
.desc = NTR-01 - Nanotrasen energy Revolver model-1, первый рабочий прототип энергетического револьвера с портативном аккумулятором, выданный в полевое испытание всем Офицерам Синего Щита. Крайне редкая и дорогая технология NT, вымеренная до каждой детали, НЕ ПОТЕРЯЙТЕ ЕГО!
.suffix = { "ОСЩ" }
